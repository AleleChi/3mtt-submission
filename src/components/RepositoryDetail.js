...
import { Box, Text, Spinner, Alert, AlertIcon } from '@chakra-ui/react'; // Import Chakra UI components
...
const RepositoryDetail = () => {
  ...
  // Provide default values if description or stars are not available
